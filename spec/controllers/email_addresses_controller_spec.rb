...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    { address: 'test@example.com', contact_id: 1, contact_type: 'Person' }
  }
  ...
  describe "GET #new" do
    ...
    it "assigns a new email_address as @email_address" do
      get :new, {:contact_id => alice.id, :contact_type => "Person"}, valid_session
  ...
  describe "POST #create" do
    context "with valid params" do
      let(:alice) { Person.create(first_name: 'Alice', last_name: 'Smith') }
      let(:valid_attributes) { { address: 'email@example.com', contact_id: alice.id, contact_type: 'Person' } }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'test@example.com', contact_id: bob.id, contact_type: 'Person'} }
      let(:new_attributes) { {address: 'new_test@example.com', contact_id: bob.id, contact_type: 'Person' } }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq("new_test@example.com")
